...
public class NamespacePrefixMappings implements NamespaceContext, org.apache.xml.utils.PrefixResolver {
  ...
  /*
   * Refer
   * https://github.com/OfficeDev/Open-XML-SDK/blob/master/src/DocumentFormat.
   * OpenXml/Framework/NamespaceIdMap.cs
   ...
   * 
   * @param namespaceUri
   *                      The namespace URI for which the prefix needs to be
   *                      found.
   *                      Never be null. "" is used to denote the default
   *                      namespace.
   * @param suggestion
   *                      When the content tree has a suggestion for the prefix
   *                      to the given namespaceUri, that suggestion is passed as
   *                      a
   *                      parameter. Typically this value comes from
   *                      QName.getPrefix()
   *                      to show the preference of the content tree. This
   *                      parameter
   *                      may be null, and this parameter may represent an already
   *                      occupied prefix.
   * @param requirePrefix
   *                      If this method is expected to return non-empty prefix.
   *                      When this flag is true, it means that the given
   *                      namespace URI
  ...
  public static String getPreferredPrefixStatic(String namespaceUri, String suggestion, boolean requirePrefix) {
    ...
    // }
    // if
    // (namespaceUri.equals("http://schemas.openxmlformats.org/drawingml/2006/compatibility"))
    // {
    // return "?";
    // }
    // if
    // (namespaceUri.equals("http://schemas.openxmlformats.org/drawingml/2006/lockedCanvas"))
    // {
    // return "?";
    // }
    // if
    // (namespaceUri.equals("http://schemas.openxmlformats.org/drawingml/2006/chartDrawing"))
    // {
    // return "?";
    // }
    ...
    // if
    // (namespaceUri.equals("http://schemas.openxmlformats.org/officeDocument/2006/bibliography"))
    // {
    // return "?";
    // }
    // if
    // (namespaceUri.equals("http://schemas.openxmlformats.org/schemaLibrary/2006/main"))
    // {
    // return "?";
    // }
    ...
    // some of the below are invented since nothing is prescribed in [MS-ODRAWML] or
    // NamespaceIdMap
  ...
  /*
   * Implement org.apache.xml.utils.PrefixResolver, for
