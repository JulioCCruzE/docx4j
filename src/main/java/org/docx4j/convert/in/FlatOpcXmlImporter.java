...
public class FlatOpcXmlImporter {
  ...
  public FlatOpcXmlImporter(InputStream is) throws JAXBException {
    ...
    // (org.docx4j.xmlPackage.Package)((JAXBElement)u.unmarshal(
    ...
    try {
      ...
      if (e.getMessage() != null
        ...
        throw new IllegalArgumentException(
            "Word 2003 XML is not supported. Use a docx or Flat OPC XML instead, or look at the Word2003XmlConverter proof of concept.");
  ...
  public OpcPackage get() throws Docx4JException {
    ...
    if (target.startsWith("/")) {
      ...
      // Target="/word/document2.xml" Id="rId1" />
  ...
  public static RelationshipsPart populateRelationshipsPart(RelationshipsPart rp, org.w3c.dom.Element el)
  ...
  private void getPart(OpcPackage pkg, RelationshipsPart rp, Relationship r)
    ...
    if (r.getTargetMode() == null
      ...
      // source = r.getSource();
      // resolvedPartUri = URIHelper.resolvePartUri(r.getSourceURI(), r.getTargetURI()
      // ).toString();
    ...
    try {
      ...
      try {
        ...
        if (part instanceof org.docx4j.openpackaging.parts.ThemePart) {
          ...
          // org.docx4j.openpackaging.parts.digitalsignature.XmlSignaturePart ) {
          //
          // ((org.docx4j.openpackaging.parts.JaxbXmlPart)part).setJAXBContext(Context.jcXmlDSig);
          // ((org.docx4j.openpackaging.parts.JaxbXmlPart)part).unmarshal( el );

        } else if (part.getClass().getName()
            .equals("org.docx4j.openpackaging.parts.digitalsignature.XmlSignaturePart")) {
          ...
          try {
            ...
            if (o instanceof CoverPageProperties) {
              ...
              // from docx -> package-> flatopc -> package -> docx, it is added to the custom
              // xml root element.
              try {
  ...
  public static void main(String[] args) throws Exception {
    ...
    org.docx4j.convert.out.flatOpcXml.FlatOpcXmlCreator outWorker = new org.docx4j.convert.out.flatOpcXml.FlatOpcXmlCreator(
        wordMLPackage);
    ...
    log.debug(
        org.docx4j.XmlUtils.marshaltoString(result, suppressDeclaration, prettyprint,
