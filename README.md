...
This code is a custom version of docx4j-6.1.2 base code in order to add
new Namespaces from new Microsoft Office updates.
...
- Specifically I want to use the recent Namespaces of Word documents.
- The Namespaces was taken from the docx4j-8.3-15 version code.
